...
export enum Privileges {
	...
	SETTLEMENTS_REQUEST_DISPUTE_MATRIX = "SETTLEMENTS_REQUEST_DISPUTE_MATRIX",
	EXECUTE_SETTLEMENT_MATRIX = "SETTLEMENTS_EXECUTE_MATRIX",
	GET_SETTLEMENT_MATRIX_REQUEST = "SETTLEMENTS_GET_MATRIX_REQUEST",
	GET_BATCH_SPECIFIC_SETTLEMENT_MATRIX_REQUEST = "GET_BATCH_SPECIFIC_SETTLEMENT_MATRIX_REQUEST",
