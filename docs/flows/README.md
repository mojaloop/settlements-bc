...
|-------|-----------------------------|--------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `01.` | **/transfer**               | `POST` | Create a settlement transfer (settlement obligation).                                                                                                                                                                                                                                                                                               |
| `02.` | **/matrix**                 | `POST` | Create a settlement matrix and return the matrix UUID *(newly generated)*. Batches that match the matrix criteria will be included as part of the settlement matrix. Any newly created batches will not be automatically associated with the settlement matrix. Newly created transfers will still be allocated to batches that are not yet closed. |
| `03.` | **/matrix/:id/recalculate** | `POST` | Request a re-calculation for a previous settlement matrix based on UUID. The re-calculation will include any newly created batches that match the settlement matrix criteria.                                                                                                                                                                       |
| `04.` | **/matrix/:id/close**       | `POST` | Close settlement batches and settlement matrix. Generate a settlement matrix as response. Once a settlement batch is closed, the balances for the batches and accounts will not change. No newly created transfers will be allocated to a closed batch.                                                                                             |
| `05.` | **/batches/:id**            | `GET`  | Retrieve settlement batch by id. The batches include the settlement accounts.                                                                                                                                                                                                                                                                       |
| `06.` | **/batches**                | `GET`  | Retrieve all settlement batches.                                                                                                                                                                                                                                                                                                                    |
| `07.` | **/settlement_accounts**    | `GET`  | Retrieve all settlement accounts.                                                                                                                                                                                                                                                                                                                   |
| `08.` | **/transfers**              | `GET`  | Retrieve all settlement transfers.                                                                                                                                                                                                                                                                                                                  |
| `09.` | **/matrix/:id**             | `GET`  | Retrieve the settlement matrix by id. If the settlement matrix is not in a closed state, the batch and account balances for the open batches may change due to new transfers.                                                                                                                                                                       |
