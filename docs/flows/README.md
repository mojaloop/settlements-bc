...
| `04.` | **/matrix/:id/close**       | `POST`   | Close settlement batches and settlement matrix.                                                                                                                                                                                                                                                                                                     |
| `04.` | **/matrix/:id/settle**      | `POST`   | Settle applicable settlement batches and settlement matrix. Generate a settlement matrix as response. Once a settlement batch is settled, the balances for the batches and accounts will not change. No newly created transfers will be allocated to settled batches.                                                                               |
| `04.` | **/matrix/:id/dispute**     | `POST`   | Dispute settlement batches and settlement matrix.                                                                                                                                                                                                                                                                                                   |
...
| `08.` | **/transfers**              | `GET`    | Retrieve all settlement transfers by batch id, batch name, transfer id or matrix id.                                                                                                                                                                                                                                                                |
